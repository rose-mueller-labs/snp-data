...
LOC_PATH = "/mnt/drosophila-lab/GenomicsProject/PopModels"
...
# Save outputs
pd.DataFrame(results).to_csv('pop_model_results.csv', index=False)
pd.DataFrame(best_results).to_csv('optimal_thresholds_pop.csv', index=False)
